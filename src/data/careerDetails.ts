...
export const careerDetails: CareerDetail[] = [
  // Realista (R)
  {
    ...
    relatedSubtypes: [
      { label: 'EXECUÇÃO', type: 'R' },
      { label: 'ANÁLISE', type: 'I' },
      { label: 'LIDERANÇA', type: 'E' },
      { label: 'ESTRUTURA', type: 'C' },
    ],
  },
  {
    name: 'Mecânica',
    ...
    relatedSubtypes: [
      { label: 'MANUTENÇÃO', type: 'R' },
      { label: 'DIAGNÓSTICO', type: 'I' },
      { label: 'CONTROLE', type: 'C' },
      { label: 'COOPERAÇÃO', type: 'S' },
    ],
  },
  {
    name: 'Agricultura',
    ...
    relatedSubtypes: [
      { label: 'CONSTÂNCIA', type: 'R' },
      { label: 'PESQUISA', type: 'I' },
      { label: 'ORGANIZAÇÃO', type: 'C' },
      { label: 'INICIATIVA', type: 'E' },
    ],
  },
  {
    ...
    relatedSubtypes: [
      { label: 'PRODUÇÃO', type: 'R' },
      { label: 'GRUPO', type: 'S' },
      { label: 'DECISÃO', type: 'E' },
      { label: 'ESTRUTURA', type: 'C' },
    ],
  },
  {
    ...
    relatedSubtypes: [
      { label: 'FERRAMENTAS', type: 'R' },
      { label: 'CURIOSIDADE', type: 'I' },
      { label: 'PRECISÃO', type: 'C' },
      { label: 'CUIDADO', type: 'S' },
    ],
  },
  ...
  },
  {
    ...
    relatedSubtypes: [
      { label: 'CURIOSIDADE', type: 'I' },
      { label: 'INOVAÇÃO', type: 'A' },
      { label: 'AMBIÇÃO', type: 'E' },
      { label: 'ESTRUTURA', type: 'C' },
    ],
  },
  {
  ...
  },
  {
    ...
    relatedSubtypes: [
      { label: 'ESTÉTICA', type: 'A' },
      { label: 'EXECUÇÃO', type: 'R' },
      { label: 'OBSERVAÇÃO', type: 'I' },
      { label: 'INFLUÊNCIA', type: 'E' },
    ],
  },
  {
    name: 'Publicidade',
  ...
  },
  {
    ...
    relatedSubtypes: [
      { label: 'ORGANIZAÇÃO', type: 'C' },
      { label: 'RACIOCÍNIO', type: 'I' },
      { label: 'AMBIÇÃO', type: 'E' },
      { label: 'ESTABILIDADE', type: 'R' },
    ],
  },
  {
    name: 'Administração',
